# Phase 3: MarkdownEditor Enhancement
...
Add live preview pane to MarkdownEditor with toggle and sync scrolling.

---

## Tasks

### 3.1 Update MarkdownEditor Component (35 min)
...
### 3.3 Add Fullscreen Button (5 min)

Add fullscreen button to toolbar:

```typescript
// In toolbar, after preview toggle
{previewVisible && (
  <>
    <div className="w-px h-4 bg-border mx-1" />
    <ToolbarButton
...
- [ ] MarkdownEditor compiles without errors
- [ ] Preview pane shows rendered markdown
- [ ] Preview toggle works
- [ ] Sync scrolling works between editor and preview
- [ ] Fullscreen preview dialog works
- [ ] All toolbar buttons still work

---

## Next Phase

After editor is enhanced, proceed to **Phase 4: Prose Class Alignment**.
